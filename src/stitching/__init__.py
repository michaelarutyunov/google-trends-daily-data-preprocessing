...
Provides five stitching methods:
...
- SmoothAlphaStitcher: Hierarchical + smoothness penalty on alphas (Rung 4, for high alpha CV)
- StateSpaceStitcher: Exploratory heuristic with exponential smoothing (nb/08, reference only)
"""
...
from .state_space import StateSpaceStitcher
